"""从 gyzb 文件夹的 HTML 导出文件中提取文章，生成 raw_material markdown"""
import re, html
from pathlib import Path

gyzb_dir = Path(r"e:\github\stock-research-backup\temp11\gyzb")
out_md = Path(r"e:\github\stock-research-backup\temp11\gyzb_raw_material.md")

articles = []

for html_path in sorted(gyzb_dir.glob("*/index.html")):
...
# --- 写入 raw_material markdown ---
with open(out_md, "w", encoding="utf-8") as f:
    f.write("# Raw Material - gyzb 机构早参\n\n")
    for a in articles:
        f.write("## Article\n")
