"""从 ljrz 文件夹的 HTML 文件中提取文章，生成 raw_material markdown"""
import re, html
from pathlib import Path

ljrz_dir = Path(r"e:\github\stock-research-backup\temp11\ljrz")
out_md = Path(r"e:\github\stock-research-backup\temp11\ljrz_raw_material.md")

articles = []

for html_path in sorted(ljrz_dir.glob("*/index.html")):
