"""从 dns 文件夹的 HTML 文件中提取文章，生成 raw_material markdown"""
import re, html
from pathlib import Path

dns_dir = Path(r"e:\github\stock-research-backup\temp11\dns")
out_md = Path(r"e:\github\stock-research-backup\temp11\dns_raw_material.md")

articles = []

for html_path in sorted(dns_dir.glob("*/index.html")):
